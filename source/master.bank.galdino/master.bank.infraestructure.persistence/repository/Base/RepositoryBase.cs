...
using master.bank.infraestructure.persistence.configuration;
using master.bank.infraestructure.persistence.configuration.exceptions;

namespace master.bank.infraestructure.persistence.repository.Base;
